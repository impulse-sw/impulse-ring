...
typedef int (*ir_handler)(const uint8_t *req, size_t req_len,
                          uint8_t **resp, size_t *resp_len, void *user);
...
ir_publisher *ir_publish_channel(ir_conn *c, const char *name,
                                 const char *schema_json, const char *key);
...
int ir_expose_function(ir_conn *c, const char *name,
                       const char *req_schema_json, const char *resp_schema_json,
...
int ir_call(ir_conn *c, const char *fn_name, const char *key,
            const uint8_t *req, size_t req_len, int timeout_ms,
