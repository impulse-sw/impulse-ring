...
use impulse_core::avro;
use impulse_core::frame::Frame;
use impulse_core::proto::{self, status, Kind, RpcRequest, RpcResponse};
use impulse_core::ring::Ring;
    ...
    F: Fn(Req) -> Resp + Send + 'static,
{
    std::thread::spawn(move || {
        ...
        while running.load(Ordering::Relaxed) {
            ...
            let response = handle_one::<Req, Resp, F>(
                &req,
                &req_schema,
                &resp_schema,
                req_fp,
